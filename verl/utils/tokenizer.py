...
def hf_tokenizer(name_or_path, correct_pad_token=True, correct_gemma2=True, do_search=True, **kwargs):
    ...
    # if "qwen" in name_or_path.lower() and do_search:
    #     warnings.warn('Found Qwen tokenizer. Add special tokens <think>, </think>. If you want to use your own special tokens, please set do_search in verl.utils.tokenizer.hf_tokenizer to False.')
